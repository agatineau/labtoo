...
class User extends BaseUser implements ParticipantInterface
{
    ...
    use \Cocorico\MangoPayBundle\Model\UserMangoPayableTrait;
    use \Cocorico\BalanceBundle\Entity\Traits\UserBalanceableTrait;
     ...
     * @Assert\NotNull
     */
    protected $personType = self::PERSON_TYPE_LEGAL;
     ...
     * @var string
     *
     * @ORM\Column(name="email_legal", type="string")
     *
     * @Assert\Email(message="cocorico_user.email_legal.invalid", strict=true, groups={"CocoricoRegistration", "CocoricoProfileContact"})
     *
     * @Assert\NotBlank(message="cocorico_user.email_legal.blank", groups={"CocoricoRegistration", "CocoricoProfileContact"})
     *
     * @Assert\Length(
     *     min=3,
     *     max="255",
     *     minMessage="cocorico_user.email_legal.short",
     *     maxMessage="cocorico_user.email_legal.long",
     *     groups={"CocoricoRegistration"}
     * )
     */
    protected $emailLegal;
     ...
     *  "CocoricoKYC", "CocoricoProfileBankAccount"
     * })
     */
    protected $birthday;
     ...
     *
     * @Assert\NotBlank(message="cocorico_user.nationality.blank", groups={
     *  "CocoricoKYC", "CocoricoProfileBankAccount"
     * })
     */
    ...
    /**
     * @ORM\Column(name="contact_email_verified", type="boolean", nullable=true)
     *
     * @var bool
     */
    protected $emailLegalVerified = false;
     ...
     * For Asserts : @see \Cocorico\UserBundle\Validator\Constraints\UserValidator.
     *
     * @ORM\OneToMany(targetEntity="UserDocument", mappedBy="user", cascade={"persist", "remove"}, orphanRemoval=true)
     * @ORM\OrderBy({"position" = "asc"})
     *
     * @var UserDocument[]
     */
     ...
     * @var string
     *
     * @ORM\Column(name="first_name_legal", type="string", length=255, nullable=true)
     */
    protected $firstNameLegal;


    /**
     * @var string
     *
     * @ORM\Column(name="last_name_legal", type="string", length=255, nullable=true)
     */
    protected $lastNameLegal;
     ...
     * @var string
     *
     * @ORM\Column(name="research_gate", type="string", length=255, nullable=true)
     */
    ...
    {
        if (!$this->personType) {
            $this->personType = self::PERSON_TYPE_LEGAL;
        }
    ...
    /**
     * Set emailLegalVerified.
     *
     * @param bool $emailLegalVerified
     *
     * @return User
     */
    public function setEmailLegalVerified($emailLegalVerified)
    {
        $this->emailLegalVerified = $emailLegalVerified;

        return $this;
    }

    /**
     * Get emailLegalVerified.
     *
     * @return bool
     */
    public function getEmailLegalVerified()
    {
        return $this->emailLegalVerified;
    }
     ...
     * @return string
     */
    public function getEmailLegal()
    {
        return $this->emailLegal;
    }

    /**
     * @param string $emailLegal
     */
    public function setEmailLegal($emailLegal)
    {
     ...
     * @return string
     */
    public function getFullNameLegal()
    {
        return sprintf("%s %s", $this->getFirstNameLegal(), $this->getLastNameLegal());
    }
     ...
     * Add document.
     *
     * @param \Cocorico\UserBundle\Entity\UserDocument $image
     *
     * @return Listing
     */
    public function addDocument(UserDocument $image)
    {
        $image->setUser($this); //Because the owning side of this relation is user image
     ...
     * @param \Cocorico\UserBundle\Entity\UserDocument $image
     */
    public function removeDocument(UserDocument $image)
    {
     ...
     * @return string
     */
    public function getFirstNameLegal()
    {
     ...
     * Set firstNameLegal.
     *
     * @param string $firstNameLegal
     *
     * @return User
     */
    public function setFirstNameLegal($firstNameLegal)
    {
     ...
     * @return string
     */
    public function getLastNameLegal()
    {
        return $this->lastNameLegal;
    }

    /**
     * Set lastNameLegal.
     *
     * @param string $lastNameLegal
     *
     * @return User
     */
    public function setLastNameLegal($lastNameLegal)
    {
        $this->lastNameLegal = $lastNameLegal;
