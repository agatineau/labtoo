...
class HomeController extends Controller
{
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function headerTextAction(Request $request)
    {
        /** @var ListingRepository $listingRepository */
        $headerText = $this->getDoctrine()->getRepository('CocoricoCoreBundle:HeaderText')->findOneBy(['published' => 1, 'sectionType' => HeaderText::SECTION_TYPE_BANNER]);

        return $this->render(
            '@CocoricoCore/Frontend/Common/header_text.html.twig',
            array(
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function headerBlogTextAction(Request $request)
    {
        $headerBlogText = $this->getDoctrine()->getRepository('CocoricoCoreBundle:HeaderText')->findOneBy(['published' => 1, 'sectionType' => HeaderText::SECTION_TYPE_BLOG]);

        return $this->render(
            '@CocoricoCore/Frontend/Common/header_blog_text.html.twig',
            array(
                'headerBlogText' => $headerBlogText,
            )
        );
    }
