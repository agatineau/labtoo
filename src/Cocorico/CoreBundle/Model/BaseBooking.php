...
//    const STATUS_CANCELED_OFFERER = 7;
    ...
    const STATUS_DISPUTED_ASKER = 9;
    const STATUS_CANCELED_ADMIN = 10;
    const STATUS_VALIDATED_ADMIN = 11;
...
//        self::STATUS_CANCELED_OFFERER => 'entity.booking.status.canceled_offerer',
        ...
        self::STATUS_DISPUTED_ASKER => 'entity.booking.status.disputed_asker',
        self::STATUS_CANCELED_ADMIN => 'entity.booking.status.canceled_admin',
        self::STATUS_VALIDATED_ADMIN => 'entity.booking.status.validated_admin',
    );
...
//        self::STATUS_CANCELED_OFFERER,
    ...
    public static $validatableStatus = array(
        self::STATUS_PAYED,
        self::STATUS_DISPUTED_ASKER,
    );

    //Status for which booking can be disputed by asker
    public static $disputableStatus = array(
        self::STATUS_PAYED
    );

    //Status for which booking can be refunded
    public static $refundableStatus = array(
        self::STATUS_PAYED,
        self::STATUS_DISPUTED_ASKER,
    );
    ...
    /**
     * @ORM\Column(name="canceled_admin_booking_at", type="datetime", nullable=true)
     *
     * @var \DateTime
     */
    protected $canceledAdminBookingAt;
    ...
    /**
     * Get Status Short Text
     *
     * @return string
     */
    public function getStatusShortText()
    {
        return str_replace('entity.booking.status.', '', $this->getStatusText());
    }
    ...
    {
        return ($this->amount + $this->amountFeeAsAsker) / (1 + $vatRate);
    }
     ...
     * @return \DateTime
     */
    public function getCanceledAdminBookingAt()
    {
        return $this->canceledAdminBookingAt;
    }

    /**
     * @param \DateTime $canceledAdminBookingAt
     */
    public function setCanceledAdminBookingAt($canceledAdminBookingAt)
    {
        $this->canceledAdminBookingAt = $canceledAdminBookingAt;
    }
