...
class BookingAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ...
            ->add(
                'canceledAdminBookingAt',
                null,
                array(
                    'disabled' => true,
                    'label' => 'admin.booking.canceled_admin_booking_at.label',
                )
            );

        if (array_key_exists("CocoricoDisputeBundle", $this->bundles)) {
            $formMapper
                ->add(
                    'disputedAskerBookingAt',
                    null,
                    array(
                        'disabled' => true,
                        'label' => 'admin.booking.disputed_asker_booking_at.label',
                    )
                );
        }
...
//            );
    ...
    public function getExportFields()
    {
        return array(
            ...
            'Asker Fees' => 'amountFeeAsAskerDecimal',
            'Offerer Fees' => 'amountFeeAsOffererDecimal',
            'Booking from' => 'start',
            'Booking to' => 'end',
            'Expire At' => 'endTime',
