...
//    public static $messageStatusInvalidated = "listing_status.invalidated";
    ...
    public static $messageAnswerRequired = "listing_answer.required";
    public static $messageExperiment = "listing_experiment.invalid";
    ...
    public static function getTranslationMessages()
    {
        ...
        $messages[] = new Message(self::$messageAnswerRequired, 'cocorico_listing');
        $messages[] = new Message(self::$messageExperiment, 'cocorico_listing');
