 ...
 *    @ORM\Index(name="mangopay_card_pre_auth_id_idx", columns={"mangopay_card_pre_auth_id"})
 *  })
 *
 */
class Booking extends BaseBooking
{
    ...
    use \Cocorico\MangoPayBundle\Model\BookingMangoPayableTrait;
    use \Cocorico\ExperimentBundle\Model\BookingExperimentableTrait;
    use \Cocorico\DisputeBundle\Model\BookingDisputableTrait;
    use \Cocorico\BalanceBundle\Entity\Traits\BookingBalanceableTrait;
//    use \Cocorico\VoucherBundle\Model\VoucherableTrait;
//    use \Cocorico\ListingOptionBundle\Model\OptionableTrait;
//    use \Cocorico\DeliveryBundle\Model\BookingDeliverableTrait;
//    use \Cocorico\CarrierBundle\Model\BookingCarrierableTrait;
...
//            }
    ...
    public function hasStarted()
    {
        ...
        return $this->getStart() ? ($this->getStart()->format('Ymd') <= $now->format('Ymd')) : false;
    }
    ...
    {
        return (string)$this->getId() . " (" . $this->getListing() . ($this->getStart() ? ":" . $this->getStart()->format('d-m-Y') : "") . ")";
    }
}
