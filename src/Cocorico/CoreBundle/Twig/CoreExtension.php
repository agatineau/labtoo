...
class CoreExtension extends \Twig_Extension implements \Twig_Extension_GlobalsInterface
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            new \Twig_SimpleFunction('vatExcludeText', array($this, 'vatExcludeText')),
        );
    }
    ...
    /**
     * Display VAT exclude text
     *
     * @param string    $locale
     *
     * @return string
     */
    public function vatExcludeText($locale)
    {
        return $this->translator->trans(
                'vat_excluded',
                array(),
     ...
     * @return mixed
     */
    public function userName($userlastname)
    {
        return ucfirst(substr($userlastname, 0, 1));
    }
...
//            Booking::STATUS_CANCELED_OFFERER => 'btn-salmon',
            ...
            Booking::STATUS_DISPUTED_ASKER => 'btn-salmon',
            Booking::STATUS_CANCELED_ADMIN => 'btn-salmon',
            Booking::STATUS_VALIDATED_ADMIN => 'btn-algae-green'
        );
        ...
        $experimentImage = new \ReflectionClass("Cocorico\ExperimentBundle\Entity\ExperimentImage");
        $experimentImageConstants = $experimentImage->getConstants();

        $balanceMovement = new \ReflectionClass("Cocorico\BalanceBundle\Entity\BalanceMovement");
        $balanceMovementConstants = $balanceMovement->getConstants();
        ...
        return array(
            ...
            'ExperimentImageConstants' => $experimentImageConstants,
            'BalanceMovementConstants' => $balanceMovementConstants,
        );
    }
